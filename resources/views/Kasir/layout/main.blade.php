        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                        <h2 class="text-center" style="font-family: 'DM Sans'; font-size:15px; font-weight:bold; ">GRAFIK PRODUK</h2>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h2 class="text-center" style="font-family: 'DM Sans'; font-size:15px; font-weight:bold; ">GRAFIK PENJUALAN</h2>
                            <div class="tab-content p-0">
                                <!-- Morris chart - Sales -->
                                <div class="chart tab-pane active" id="revenue-chart"
                                    style="position: relative; height: 300px;">
